const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/supabase.D_JG6q5l.js","_astro/preload-helper.L5lOfJxi.js"])))=>i.map(i=>d[i]);
import{c as e,l as t,s as n,t as r}from"./supabase.D_JG6q5l.js";import{t as i}from"./preload-helper.L5lOfJxi.js";var a=[`Janvier`,`Février`,`Mars`,`Avril`,`Mai`,`Juin`,`Juillet`,`Août`,`Septembre`,`Octobre`,`Novembre`,`Décembre`],o={},s=``;function c(){let e=document.getElementById(`filter-gender-select`);e&&e.addEventListener(`change`,()=>{s=e.value,x()})}c();function l(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}var u=[],d=[],f={},p={};function m(){return u}function h(e){return d.filter(t=>t.guideId===e)}function g(e,t){let n=(f[e]||{})[t];if(!n||n.length===0)return[];let r=(p[e]||{})[t]||[];return r.includes(`*`)?[]:n.filter(e=>!r.includes(e))}async function _(){let[i,a,o,s]=await Promise.all([t.from(`guides`).select(`*`).order(`created_at`),t.from(`reviews`).select(`*`).not(`guide_id`,`is`,null),t.from(`availability`).select(`guide_id, date, slots`),t.from(`booked_dates`).select(`guide_id, date, slot`)]);u=(i.data||[]).map(n),d=(a.data||[]).map(e),f={},(o.data||[]).forEach(e=>{(f[e.guide_id]=f[e.guide_id]||{})[e.date]=e.slots||r.slice()}),p={},(s.data||[]).forEach(e=>{let t=p[e.guide_id]=p[e.guide_id]||{};(t[e.date]=t[e.date]||[]).push(e.slot||`*`)})}var v={français:`FR`,francais:`FR`,arabe:`AR`,anglais:`EN`,espagnol:`ES`,turc:`TR`,ourdou:`UR`,indonésien:`ID`,indonesien:`ID`};function y(e){return v[e.trim().toLowerCase()]||e.trim().slice(0,2).toUpperCase()}function b(e){let t=Math.round(e),n=``;for(let e=1;e<=5;e++)n+=`<span class="gp-star ${e<=t?`gp-star--full`:``}">★</span>`;return n}function x(){let e=document.getElementById(`guides-list`),t=document.getElementById(`guides-empty`);if(!e)return;let n=m();if(s&&(n=n.filter(e=>e.gender===s)),e.querySelectorAll(`.gp-card`).forEach(e=>e.remove()),document.querySelectorAll(`body > .gp-cal`).forEach(e=>e.remove()),n.length===0){t&&(t.textContent=s?`Aucun guide ne correspond à vos critères.`:`Aucun guide disponible pour le moment.`,t.hidden=!1);return}t&&(t.hidden=!0),n.forEach(t=>{let n=t.city===`medina`?`Médine`:`La Mecque`,r=(t.firstName?.[0]||``)+(t.lastName?.[0]||``),i=(t.languages||[]).map(e=>y(e)),a=i.map(e=>`<span class="gp-card__lang">${l(e)}</span>`).join(``),o=(t.languages||[]).map(e=>`<span class="gp-profile__lang">${l(e.trim())}</span>`).join(``),s=h(t.id),c=s.length,u=c>0?s.reduce((e,t)=>e+(t.stars||5),0)/c:0,d=u.toFixed(1).replace(`.`,`,`),f=c>0?`<div class="gp-card__rating"><span class="gp-card__rating-star">★</span><span class="gp-card__rating-num">${d}</span><span class="gp-card__reviews">(${c} avis)</span></div>`:`<div class="gp-card__rating"><span class="gp-card__rating-star">★</span><span class="gp-card__reviews">(0 avis)</span></div>`,p=t.photo?`<div class="gp-card__avatar gp-card__avatar--photo" style="background-image:url(${t.photo})"></div>`:`<div class="gp-card__avatar gp-card__avatar--${t.city}">${l(r)}</div>`,m=t.photo?`<img src="${t.photo}" alt="${l(t.firstName)} ${l(t.lastName)}" class="guide-visual__image" />`:`<div class="guide-visual__image guide-visual__image--initials guide-visual__image--${t.city}">${l(r)}</div>`,g=s.filter(e=>(e.text||``).trim().length>0),_=g.length>0?g[Math.floor(Math.random()*g.length)]:null,v=c>0?`
          <div class="gp-profile__reviews">
            ...
            <div class="gp-profile__rv-quote">
              <span class="gp-profile__rv-label">Ils ont voyag&eacute; avec ${l(t.firstName)}</span>
              ${_?`<p class="gp-profile__rv-text">&ldquo;${l(_.text)}&rdquo;</p><span class="gp-profile__rv-author">&ndash; ${l(_.name||`Anonyme`)}</span>`:`<p class="gp-profile__rv-text gp-profile__rv-text--empty">Aucun commentaire d&eacute;taill&eacute; pour le moment.</p>`}
          ...
          <div class="gp-profile__reviews gp-profile__reviews--empty">
            ...
            <p class="gp-profile__rv-text gp-profile__rv-text--empty">Aucun avis pour le moment. Soyez le premier &agrave; voyager avec ${l(t.firstName)} !</p>
        ...
        <div class="gp-card__body">
          <div class="gp-card__main">
            ...
            <div class="gp-card__info">
              <h2 class="gp-card__name">${l(t.firstName)} ${l(t.lastName)}</h2>
              ${t.diploma?`<p class="gp-card__diploma">${l(t.diploma)}</p>`:``}
              ${i.length?`<div class="gp-card__langs">${a}</div>`:``}
              ${f}
            </div>
            <div class="gp-card__right">
              ${t.pricePerDay?`<div class="gp-card__price"><span class="gp-card__amount">${l(String(t.pricePerDay))}&euro;</span><span class="gp-card__unit">Frais inclus</span></div>`:``}
              ...
              <div class="gp-profile__sheet">
                <div class="gp-profile__top">
                  ...
                  <div class="gp-profile__id">
                    ...
                    <h3 class="gp-profile__name">${l(t.firstName)} ${l(t.lastName)}</h3>
                    ${t.diploma?`<p class="gp-profile__diploma">${l(t.diploma)}</p>`:``}
                    ${o?`<div class="gp-profile__langs">${o}</div>`:``}
                    ${t.description?`<p class="gp-profile__desc">${l(t.description)}</p>`:``}
                  </div>
                </div>
          ...
          <div class="gp-cal__header">
            ...
            <p class="gp-cal__guide-name">avec ${l(t.firstName)} ${l(t.lastName)}</p>
          </div>
      ...
      `,e.appendChild(x)}),e.querySelectorAll(`.gp-cal`).forEach(e=>document.body.appendChild(e)),w()}function S(e){let t=o[e];if(!t)return;let n=document.getElementById(`cal-month-${e}`),r=document.getElementById(`cal-grid-${e}`);if(!n||!r)return;n.textContent=`${a[t.month]} ${t.year}`,r.innerHTML=``;let i=new Date(t.year,t.month,1).getDay(),s=i===0?6:i-1,c=new Date(t.year,t.month+1,0).getDate(),l=new Date;l.setHours(0,0,0,0);for(let e=0;e<s;e++){let e=document.createElement(`span`);e.className=`gp-cal__day gp-cal__day--empty`,r.appendChild(e)}for(let n=1;n<=c;n++){let i=`${t.year}-${String(t.month+1).padStart(2,`0`)}-${String(n).padStart(2,`0`)}`,a=new Date(t.year,t.month,n)<l,o=(a?[]:g(e,i)).length>0,s=t.selectedDate===i,c=document.createElement(`button`);c.type=`button`,c.textContent=String(n),c.className=`gp-cal__day`,o?c.classList.add(`gp-cal__day--available`):c.classList.add(`gp-cal__day--unavailable`),a&&c.classList.add(`gp-cal__day--past`),s&&c.classList.add(`gp-cal__day--selected`),o?c.addEventListener(`click`,()=>{t.selectedDate=i,t.selectedSlot=null,S(e);let n=document.getElementById(`cal-sel-${e}`),r=document.getElementById(`cal-date-${e}`);if(n&&r){let[t,a,o]=i.split(`-`).map(Number);r.textContent=`Date sélectionnée : ${new Date(t,a-1,o).toLocaleDateString(`fr-FR`,{weekday:`long`,day:`numeric`,month:`long`,year:`numeric`})}`,n.classList.remove(`is-hidden`);let s=document.getElementById(`cal-wrap-${e}`),c=document.getElementById(`cal-reopen-${e}`);s&&c&&(s.classList.add(`is-collapsed`),c.classList.remove(`is-hidden`),c.classList.remove(`is-open`));let l=g(e,i);n.querySelectorAll(`.gp-cal__slot`).forEach(e=>{let t=e.dataset.slot,n=l.includes(t);e.disabled=!n,e.classList.toggle(`is-unavailable`,!n),e.classList.remove(`is-selected`)}),n.querySelectorAll(`.gp-cal__action`).forEach(e=>e.disabled=!0)}}):c.disabled=!0,r.appendChild(c)}}function C(e){let t=m().find(t=>t.id===e);if(!t)return;let n=h(e),r=n.map(e=>`
      <article class="gp-rvmodal__item">
        <div class="gp-rvmodal__item-head">
          <span class="gp-rvmodal__stars">${b(e.stars||5)}</span>
          <span class="gp-rvmodal__author">${l(e.name||`Anonyme`)}</span>
        </div>
        ${(e.text||``).trim()?`<p class="gp-rvmodal__text">&ldquo;${l(e.text)}&rdquo;</p>`:``}
      ...
      <div class="gp-rvmodal__panel">
        ...
        <p class="gp-rvmodal__guide">sur ${l(t.firstName)} ${l(t.lastName)} &middot; ${n.length} avis</p>
        <div class="gp-rvmodal__list">${r}</div>
      </div>`,document.body.appendChild(i),document.body.style.overflow=`hidden`;function a(){i.remove(),document.body.style.overflow=``,document.removeEventListener(`keydown`,o)}function o(e){e.key===`Escape`&&a()}i.addEventListener(`click`,e=>{e.target===i&&a()}),i.querySelector(`.gp-rvmodal__close`)?.addEventListener(`click`,a),document.addEventListener(`keydown`,o)}function w(){document.querySelectorAll(`[data-all-reviews]`).forEach(e=>{e.addEventListener(`click`,()=>{C(e.dataset.allReviews)})}),document.querySelectorAll(`[data-toggle-profile]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.toggleProfile,n=document.getElementById(`profile-${t}`);if(!n)return;let r=n.classList.toggle(`is-open`);if(e.setAttribute(`aria-expanded`,String(r)),e.classList.toggle(`is-open`,r),!r){let e=document.getElementById(`cal-${t}`);e&&e.classList.add(`is-hidden`)}})}),document.querySelectorAll(`[data-open-cal]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.openCal,n=document.getElementById(`cal-${t}`);if(!n)return;if(document.querySelectorAll(`.gp-cal`).forEach(e=>e.classList.add(`is-hidden`)),!o[t]){let e=new Date;o[t]={year:e.getFullYear(),month:e.getMonth(),selectedDate:null,selectedSlot:null}}S(t);let r=document.getElementById(`cal-wrap-${t}`),i=document.getElementById(`cal-reopen-${t}`);r?.classList.remove(`is-collapsed`),i?.classList.add(`is-hidden`),n.classList.remove(`is-hidden`),document.body.style.overflow=`hidden`})}),document.querySelectorAll(`[data-cal-reopen]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.calReopen,n=document.getElementById(`cal-wrap-${t}`);if(!n)return;let r=n.classList.toggle(`is-collapsed`);e.classList.toggle(`is-open`,!r)})});function e(e){e.classList.add(`is-hidden`),document.body.style.overflow=``}document.querySelectorAll(`[data-cal-close]`).forEach(t=>{t.addEventListener(`click`,()=>{let n=t.closest(`.gp-cal`);n&&e(n)})}),document.querySelectorAll(`.gp-cal`).forEach(t=>{t.addEventListener(`click`,n=>{n.target===t&&e(t)})}),document.addEventListener(`keydown`,t=>{t.key===`Escape`&&document.querySelectorAll(`.gp-cal:not(.is-hidden)`).forEach(t=>e(t))}),document.querySelectorAll(`.gp-cal__slot`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.guideId,n=o[t];if(!n?.selectedDate)return;n.selectedSlot=e.dataset.slot;let r=document.getElementById(`cal-sel-${t}`);r&&(r.querySelectorAll(`.gp-cal__slot`).forEach(e=>e.classList.remove(`is-selected`)),e.classList.add(`is-selected`),r.querySelectorAll(`.gp-cal__action`).forEach(e=>e.disabled=!1))})}),document.querySelectorAll(`[data-cal-prev]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.calPrev,n=o[t];n&&(n.month--,n.month<0&&(n.month=11,n.year--),S(t))})}),document.querySelectorAll(`[data-cal-next]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.calNext,n=o[t];n&&(n.month++,n.month>11&&(n.month=0,n.year++),S(t))})}),document.querySelectorAll(`[data-action="browse"]`).forEach(t=>{t.addEventListener(`click`,async()=>{let n=t.dataset.guideId,r=o[n];if(!r?.selectedDate||!r.selectedSlot||!await T(n,r.selectedDate,r.selectedSlot))return;r.selectedDate=null,r.selectedSlot=null,S(n);let i=document.getElementById(`cal-sel-${n}`);i&&i.classList.add(`is-hidden`);let a=document.getElementById(`cal-${n}`);a&&e(a);let s=document.querySelector(`article[data-guide-id="${n}"]`);if(s&&(s.style.borderColor=`#14513A`,s.style.boxShadow=`0 0 0 2px rgba(20,81,58,0.15)`,!s.querySelector(`.gp-card__booked`))){let e=document.createElement(`span`);e.className=`gp-card__booked`,e.textContent=`Réservé`,s.querySelector(`.gp-card__right`)?.prepend(e)}})}),document.querySelectorAll(`[data-action="pay"]`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.guideId,n=o[t];!n?.selectedDate||!n.selectedSlot||await T(t,n.selectedDate,n.selectedSlot)&&await E()})})}async function T(e,n,r){let i=m().find(t=>t.id===e),{data:a,error:o}=await t.rpc(`create_booking`,{p_guide_id:e,p_date:n,p_slot:r,p_activity_slug:null,p_activity_name:null});if(o||!a)return alert(`Cette date n'est plus disponible. Le calendrier a été mis à jour.`),await _(),S(e),!1;let s=p[e]=p[e]||{};(s[n]=s[n]||[]).push(r);let c=JSON.parse(localStorage.getItem(`omra-cart`)||`[]`);return c.push({bookingId:a.id,cancelToken:a.cancel_token,guideId:e,guideName:i?`${i.firstName} ${i.lastName}`:`Guide`,guidePhoto:i?.photo||``,date:n,slot:r,activityName:``,price:i?.pricePerDay||0}),localStorage.setItem(`omra-cart`,JSON.stringify(c)),window.dispatchEvent(new Event(`cart-updated`)),!0}async function E(){let e=JSON.parse(localStorage.getItem(`omra-cart`)||`[]`);if(e.length===0)return;let t=e.map(e=>({bookingId:e.bookingId,guideName:e.guideName||`Guide`,price:e.price||0,date:e.date||``,slot:e.slot||``}));try{let{SUPABASE_URL:e,SUPABASE_ANON_KEY:n}=await i(async()=>{let{SUPABASE_URL:e,SUPABASE_ANON_KEY:t}=await import(`./supabase.D_JG6q5l.js`).then(e=>e.u);return{SUPABASE_URL:e,SUPABASE_ANON_KEY:t}},__vite__mapDeps([0,1])),r=await(await fetch(`${e}/functions/v1/create-checkout`,{method:`POST`,headers:{"Content-Type":`application/json`,Authorization:`Bearer ${n}`,apikey:n},body:JSON.stringify({items:t,successUrl:`${window.location.origin}/paiement/confirmation/?session_id={CHECKOUT_SESSION_ID}`,cancelUrl:`${window.location.origin}/guides/`})})).json();r.url?window.location.href=r.url:alert(r.error||`Erreur lors de la création du paiement.`)}catch{alert(`Erreur de connexion. Veuillez réessayer.`)}}_().then(x);